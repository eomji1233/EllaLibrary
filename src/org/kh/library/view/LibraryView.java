...
import org.kh.library.controller.BookControllerI;
import org.kh.library.controller.LibraryControllerI;
...
public class LibraryView implements LibraryViewI{
	LibraryControllerI libController;
	BookControllerI bookController;
	...
	public void bookMenu() {		
		while(true) {
			...
			switch(choice) {
			case 1:
//				ArrayList<Book> bList = bookController.selectAllBook();
				break;
			case 2:
				break;
			case 3:
